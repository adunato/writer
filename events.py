...
def feed_data_into_collector(corpus, chunk_len, chunk_sep):
    ...
    print(f"textbox {shared.gradio['textbox']}")
...
def ui():
    with gr.Accordion("Click for more information...", open=False):
        ...
        This extension allows to write chapters and then process them into an overall stroy database which is used to provide context to the following chapters.
        """))
